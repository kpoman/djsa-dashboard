...
with st.expander("ℹ️ Definición, metodología y fuentes de cada KPI"):
    ...
    _doc_kpi(
        ...
        "`control-202609.csv` — exportación estática de DairyComp",
        chart_key='l305e',
    )
    ...
    _doc_kpi(
        ...
        f"`eventos-202609.csv` — DairyComp (collares) — hasta {ref_ev}",
        chart_key='tdc',
    )
    _doc_kpi(
        ...
        f"`eventos-202609.csv` — hasta {ref_ev}",
        chart_key='tc',
    )
    _doc_kpi(
    ...
    _doc_kpi(
        ...
        f"`eventos-202609.csv` — DairyComp, registros de tratamientos — hasta {ref_ev}",
        chart_key='mast',
    )
...
| DairyComp eventos | CSV estático `eventos-202609.csv` | hasta {ref_ev} | Manual, exportar DairyComp |
| DairyComp controles | CSV estático `control-202609.csv` | hasta {ref_ctrl} | Manual, exportar DairyComp |
